...
export function AboutSection({ scrollToSection }: { scrollToSection?: (index: number) => void }) {
  ...
  return (
    <section
      ref={ref}
      className="relative flex h-screen w-screen shrink-0 snap-start items-center px-4 pt-40 md:px-12 md:pt-44 lg:px-16"
    >
          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                высокой
                <br />
                <span className="text-foreground/40">точности</span>
              </h2>
            </div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                АЗОМ — производственное предприятие в Абакане с полным циклом металлообработки: от раскроя и гибки до сварки и покраски.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Работаем с заказчиками из промышленности, строительства и ЖКХ по всей Хакасии и Красноярскому краю.
              </p>
            </div>
          </div>
