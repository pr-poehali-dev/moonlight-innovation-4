      ...
      >
        ...
        <section className="relative flex min-h-screen w-screen shrink-0 flex-col justify-end px-6 pb-16 pt-24 md:px-12 md:pb-24">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <h1 className="mb-6 w-full animate-in fade-in slide-in-from-bottom-8 font-sans text-4xl font-light leading-[1.1] tracking-tight text-black duration-1000 md:text-5xl lg:text-6xl text-center">
