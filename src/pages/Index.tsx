          ...
          <div className="relative z-10 w-full">
            <div className="mb-4 flex md:inline-block animate-in fade-in slide-in-from-bottom-4 duration-700">
              <button
                ...
                className="w-full md:hidden rounded-full border border-foreground/20 bg-foreground/10 px-4 py-2.5 backdrop-blur-md font-mono text-xs text-foreground/90 font-semibold hover:bg-foreground/15 transition-all"
              >
            ...
            <div className="mb-8 w-full animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-black/80 duration-1000 delay-200 text-justify space-y-4">
              <p>Абаканский Завод Обработки Металлов "АЗОМ"– это современное производство, обеспечивающее высокое качество металлоконструкций и комплектующих для различных отраслей. Наш опыт и передовое оборудование позволяют нам реализовывать самые сложные проекты.</p>
