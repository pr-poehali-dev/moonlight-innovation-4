...
export default function Aggregator() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (authData.ok) {
        const htmlRes = await fetch(API_URL);
      ...
      <div className="flex min-h-screen flex-col bg-gray-50 font-sans">
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-12">
          <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <h1 className="mb-6 text-xl font-bold text-gray-900">Агрегатор</h1>
    ...
    <div className="flex min-h-screen flex-col font-sans">
      ...
      <div className="flex-1">
        {html ? (
          <iframe
            srcDoc={html}
            className="h-full min-h-[calc(100vh-73px)] w-full border-0 bg-white"
          ...
          <div className="flex items-center justify-center py-24">
            <div className="text-center">
              ...
              <p className="mt-1 text-xs text-gray-400">Загрузите файл в административной панели</p>
            </div>
          </div>
        )}
      </div>
